...
EnvJasmine.loadGlobal(EnvJasmine.libDir + "jasmine-rhino-reporter/jasmine-junit-reporter.js");
EnvJasmine.loadGlobal(EnvJasmine.libDir + "jasmine/jasmine-html.js");
EnvJasmine.loadGlobal(EnvJasmine.libDir + "jasmine/jasmine.console_reporter.js");
...
//load our js framework
print("load fdev-min.js & core.js...");
EnvJasmine.loadGlobal(EnvJasmine.includeDir + "fdev-min.js");

//EnvJasmine.loadGlobal(EnvJasmine.includeDir + "jquery-1.7.1.js"); // for example, load jquery.

// so right now I found the latest jquery could not make work with mock-ajax.js ,why? need look into it.
